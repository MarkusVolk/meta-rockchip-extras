...
SRC_URI:append:rockchip = " \
	...
	file://rockchip/board-rockpis-0001-arm64-dts-rockchip-add-ROCK-Pi-S-DTS-support.patch \
	file://rockchip/board-rockpis-0002-Fixes-for-rk3308-rock-pi-s-dts.patch \
	file://rockchip/board-rockpis-0003-WIP-Wireless-support.patch \
	file://rockchip/board-rockpis-0005-arm64-dts-rk3308-Add-gmac-node-at-dtsi-level.patch \
	file://rockchip/board-rockpis-0006-arm64-dts-rockchip-Enable-mac-node-on-rk3308-rock-pi.patch \
	file://rockchip/board-rockpis-0007-arm64-dts-rockchip-add-cpu-s-thermal-config-for-rk33.patch \
	file://rockchip/board-rockpis-0008-thermal-rockchip-add-tsadc-support-for-rk3308.patch \
	file://rockchip/board-rockpis-0009-arm64-dts-rockchip-Enable-tsadc-node-on-rk3308-rock-.patch \
	file://rockchip/board-rockpis-0010-arm64-dts-rockchip-add-i2s_8ch-for-rk3308.patch \
	file://rockchip/board-rockpis-0011-arm64-dts-rockchip-Set-is2_8ch-clocks-on-rk3308-rock.patch \
	file://rockchip/board-rockpis-0012-arm64-dts-rk3308-Add-rk-timer-rtc.patch \
	file://rockchip/board-rockpis-0013-Add-simple-audio-card.patch \
	file://rockchip/board-rockpis-0015-arm64-dts-rockchip-Move-wireless-wlan-node-into-sdio.patch \
	file://rockchip/board-rockpis-0018-ASoC-codecs-Add-RK3308-internal-codec-driver.patch \
	file://rockchip/board-rockpis-0019-Sync-rk3308_codec-to-BSP-tree.patch \
	file://rockchip/board-rockpis-0020-arm64-dts-rockchip-Add-acodec-node-for-rk3308.patch \
	file://rockchip/board-rockpis-0021-arm64-dts-rockchip-enable-analog-audio-node-for-rk33.patch \
	file://rockchip/board-rockpis-0022-ASoC-rk3308_codec-replace-codec-to-component.patch \
	file://rockchip/board-rockpis-0024-add-uart2-for-debug-rock-pi-s-dts.patch \
	file://rockchip/board-rockpis-0026-add-usb-host-otg-dts.patch \
	file://rockchip/board-rockpis-0027-arm64-dts-rk3308-add-otp-cpuinfo.patch \
	file://rockchip/board-rockpis-0029-arm64-dts-rk3308-add-reserved-memory-ramoops.patch \
	file://rockchip/board-rockpis-0031-arm64-dts-rk3399-rockpro64-Add-pcie-bus-scan-delay.patch \
	...
	file://rockchip/general-add-dwc3-xhci-usb-trb-quirk.patch \
	...
	file://rockchip/general-add-panel-simple-dsi.patch \
	...
	file://rockchip/rk356x-pcie3-support.patch \
	...
	file://rockchip/wifi-4004-fix-uwe5622-park-link-policy.patch \
